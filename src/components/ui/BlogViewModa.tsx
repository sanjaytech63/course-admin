    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Blog Details" size="lg">
      <div className="max-h-[75vh] overflow-y-auto">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-6 px-2">
          {blog.badge && (
            <span
              className={`px-4 py-2 text-sm font-semibold rounded-full border ${getBadgeColor(blog.badge)}`}
            >
              {getBadgeLabel(blog.badge)}
            </span>
          )}
          <span
            className={`px-4 py-2 text-sm font-semibold rounded-full border ${getCategoryColor(blog.category)}`}
          >
                ...
                <div className="flex justify-between items-center py-2 border-b border-gray-200">
                  ...
                  <span
                    className={`text-sm font-medium ${
                      blog.isPublished ? "text-green-600" : "text-gray-600"
                    }`}
                  >
                    {blog.isPublished ? "Published" : "Draft"}
                  </span>
