...
import { FiEdit2, FiTrash2, FiEye, FiClock, FiUsers, FiStar, FiDollarSign } from 'react-icons/fi';
import Button from './Button';
import { Card } from './Card';
import { CourseCardProps } from '../../types/course.types';
import { getCategoryLabel, getLevelLabel, getBadgeLabel, } from '../../constants/index';
        ...
        <Card padding="md" className="h-full flex flex-col">
            ...
            <div className="flex-grow space-y-3 mb-4">
                <div className="flex flex-wrap items-center gap-2">
                    <span className={`px-3 py-1 text-xs font-medium rounded-full border ${getCategoryColor(course.category)}`}>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 pt-4 border-t border-gray-100">
                <div className="flex items-center text-sm">
                    <div className={`flex items-center space-x-1 px-2 py-1 rounded-full text-xs ${course.isActive
                        ? 'bg-green-100 text-green-700'
                        : 'bg-gray-100 text-gray-600'
                        }`}>
                        <div className={`w-2 h-2 rounded-full ${course.isActive ? 'bg-green-500' : 'bg-gray-400'
                            }`}></div>
