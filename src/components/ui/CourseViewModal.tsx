    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Course Details" size="lg">
      <div className="max-h-[75vh] overflow-y-auto">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-6 px-2">
          {course.badge && (
            <span
              className={`px-4 py-2 text-sm font-semibold rounded-full border ${getBadgeColor(course.badge)}`}
            >
              {getBadgeLabel(course.badge)}
            </span>
          )}
          <span
            className={`px-4 py-2 text-sm font-semibold rounded-full border ${getCategoryColor(course.category)}`}
          >
            {getCategoryLabel(course.category)}
          </span>
          <span
            className={`px-4 py-2 text-sm font-semibold rounded-full border ${getLevelColor(course.level)}`}
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50 rounded-xl p-6 border border-gray-200">
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center py-2 border-b border-gray-200">
                ...
                <span
                  className={`text-sm font-medium px-3 py-1 rounded-full ${getLevelColor(course.level)}`}
                >
                  {getLevelLabel(course.level)}
                </span>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center py-2 border-b border-gray-200">
                ...
                <span
                  className={`text-sm font-medium px-3 py-1 rounded-full ${getCategoryColor(course.category)}`}
                >
                  {getCategoryLabel(course.category)}
                </span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-2 border-b border-gray-200">
                  ...
                  <span
                    className={`text-sm font-medium ${course.isFeatured ? "text-yellow-600" : "text-gray-600"}`}
                  >
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-2 border-b border-gray-200">
                  ...
                  <span
                    className={`text-sm font-medium ${course.isActive ? "text-green-600" : "text-red-600"}`}
                  >
                    {course.isActive ? "Active" : "Inactive"}
                  </span>
                </div>
