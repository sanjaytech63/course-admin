...
import { createCourse, deleteCourseById, updateCourse } from '../api/course.service';
...
import { badgeOptions, categoryOptions, getCategoryLabel, itemsPerPageOptions, levelOptions } from '../constants/index';
...
export const Courses: React.FC = () => {
    ...
    }, [filters.page, filters.limit, filters.search, filters.category, filters.level]);
        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                        {pagination ? `Total ${pagination.totalItems} courses` : 'Manage platform courses'}
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 w-full">
                ...
                <div>
                    ...
                    >
                        <FiRefreshCw className={`w-4 h-4 ${courseLoading ? 'animate-spin' : ''}`} />
